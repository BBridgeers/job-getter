...
def interview_prep(job_id):
    ...
    if not questions:
        questions = [{
            ...
            "talkingPoints": ["Lead with 12+ years enterprise tech consulting",
                              "Quantify retention and adoption wins",
                              "Connect Yooz onboarding program design to this role"],
        }]
...
def generate_brief():
    ...
    telegram_sent = 0
    if send_telegram:
        bot_token = os.environ.get("TELEGRAM_BOT_TOKEN", "8997623699:AAFW3O_gkqC_voJiSym8WoJo3kn6Mudr25E")
        chat_id = os.environ.get("TELEGRAM_HOME_CHANNEL", "5457844222")
        try:
